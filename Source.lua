...
local Library = {
    ...
    FontColor = Color3.fromRGB(166, 166, 166);
    MainColor = Color3.fromRGB(19, 20, 30);
    BackgroundColor = Color3.fromRGB(47, 51, 70);
    AccentColor = Color3.fromRGB(124, 124, 124);
    OutlineColor = Color3.fromRGB(73, 71, 79);
